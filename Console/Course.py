...
class Course(object):
    ...
    def getAssignmentsForCredit(self,credit):
        ...
        for a in self.assignments.keys():
            if self.assignments[a].credit==credit:
                assignments.append(a)
            elif self.assignments[a].credit=="%d" % credit:
                assignments.append(a)
        return assignments
    def getAssignmentObjectsForCredit(self,credit):
        assignments = []
        for a in self.assignments.keys():
            if self.assignments[a].credit==credit:
                assignments.append(self.assignments[a])
            elif self.assignments[a].credit=="%d" % credit:
                assignments.append(self.assignments[a])
        return assignments
